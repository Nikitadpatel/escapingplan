          ...
          body:isLoading?Container():  Container(
            ...
            child: Column(
              ...
              children: [
                Expanded(
                  child:
                  (favouritelistmodel == null ? 0 : favouritelistmodel?.data?.length ?? 0) ==
                      0
                      ?SizedBox(
                    child: Column(
                      mainAxisAlignment: MainAxisAlignment.center,
    ...
    checkInternet().then((internet) async {
      if (internet) {
        travelprovider().favouritelist({
          ...
          FavouritelistModel favouritelistmodel1   = FavouritelistModel.fromJson(json.decode(response.body));

          if (response.statusCode == 200 && favouritelistmodel1?.status == "1") {
              favouritelistmodel = favouritelistmodel1;
