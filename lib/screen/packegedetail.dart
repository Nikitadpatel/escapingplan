                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  Expanded(
                                    flex: 4,
                                    child: Text(
                                      (detailmodal?.aboutTheTour?[0].title)
                                          .toString(),
                                      style: TextStyle(
                              ...
                              Container(
                                ...
                                //     horizontal: 5.w, vertical:0.0),
                                child: Text(
                                  (detailmodal?.aboutTheTour?[0].description)
                                      .toString(),
                                  style: textstyle,
                                  maxLines: 3,
                                  overflow: TextOverflow.ellipsis,
                              ...
                              (detailmodal
                                  ?.tourInformation?[0].endPoint != "")? Container(
                                // padding: EdgeInsets.symmetric(
                                //     horizontal: 5.w, vertical:2.0),
                                child: Row(
                                  children: [
                                                              ...
                                                              children: [
                                                                ...
                                                                Expanded(
                                                                  ...
                                                                  child: Column(
                                                                    ...
                                                                    children: [
                                                                      Text(
                                                                        (detailmodal?.hotel?[index].hotelName)
                                                                            .toString(),
                                                                        maxLines:
                                                                            2,
                                                                        overflow:
                                                                      ...
                                                                      Row(
                                                                        children: [
                                                                          ...
                                                                          Text(
                                                                              (detailmodal?.hotel?[index].location).toString(),
                                                                              style: textstyle),
                                                                        ],
                                                                      ),
                                                                      SizedBox(
                                                                      ...
                                                                      Row(
                                                                        children: [
                                                                          ...
                                                                          Text(
                                                                              (detailmodal?.hotel?[index].noOfNight).toString() + "Nights",
                                                                              style: textstyle),
                                                                        ],
                                                                      )
                                                                    ],
                                                                  ...
                                                                  ? Container(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        crossAxisAlignment:
                                                                            CrossAxisAlignment.start,
                                                                        children: [
                                                                          (detailmodal?.itinerary?[index].daysTitle == "")?Container():
                                                                          Text(
                                                                              detailmodal?.itinerary?[index].daysTitle ?? "",
                                                                              textAlign: TextAlign.left,
                                                                              maxLines: 4,
                                                                              style: TextStyle(fontSize: 14.sp, fontFamily: "Poppins", fontWeight: FontWeight.bold)),
                                                                          SizedBox(
                                                                            height:
                                                                                1.h,
                                                                          ),
                                                                          Row(
                                                                            ...
                                                                            children: [
                                                                              ...
                                                                              //   ),
                                                                              // ),
                                                                              (detailmodal?.itinerary?[index].dayDescription == "")? Text( "No description available",
                                                                                  textAlign: TextAlign.left,
                                                                                  maxLines: 4,
                                                                                  style: TextStyle(fontSize: 12.sp, fontFamily: "Poppins", fontWeight: FontWeight.normal)) :Expanded(
                                                                                child: Html(
                                                ...
                                                :
                                                     ListView.builder(
                                                        ...
                                                        itemBuilder: (context, index) {
                                                          ...
                                                          ((detailmodal?.otherInformation?.title?[index]).toString() == "Cancellation Date")?
                                                              print(detailmodal?.otherInformation?.description?[index]) :print("date");
                                                                        ...
                                                                        children: [
                                                                          Row(
                                                                            ...
                                                                            children: [
                                                                              ...
                                                                              Expanded(
                                                                                flex: 9,
                                                                                child:((detailmodal?.otherInformation?.description?[index]) != "")? Text((detailmodal?.otherInformation?.description?[index]).toString(), textAlign: TextAlign.left, maxLines: 4, style: textstyle):

                                                                                Text("No "+(detailmodal?.otherInformation?.title?[index]).toString() + " detail available.", textAlign: TextAlign.left, maxLines: 4, style: textstyle),
                                                                              ),
                                                                            ],
                                                                          ),
                                                                          SizedBox(
